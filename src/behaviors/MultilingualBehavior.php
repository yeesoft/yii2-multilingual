...
class MultilingualBehavior extends Behavior {
	...
	/**
	 * Execlude multilingual attributes from check.
	 *
	 * @var array
	 */
	public $excludeAttributesFromCheck = [];
	...
	/**
	 * Check is exist multilingual attributes for current language
	 */
	public function existMultilingualAttributes() {
		...
		foreach ($this->attributes as $attribute) {
			if (in_array($attribute, $this->excludeAttributesFromCheck)) {
				continue;
			}
